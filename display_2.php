...
var form = document.forms[0]; 
  ...
  if(ser_1=="all")
 var queryString = "?ser_1=" +  ser_1 + sr_txt + "&sts=taken"; 
 else if(sr_txt !="")
 var queryString = "?ser_1=" +  ser_1 + "&sr_txt=" + sr_txt + "&sts=taken"; 
//alert("ff");

 ajaxRequest.open("GET", "disp_result1.php" +  
                              queryString, true); 
...
window.location.href = "legend.php" +queryString;
...
<div class="container-fluid">
  ...
  <form class="form-horizontal" role="form" method="POST" action="">
      <div class="form-group">
       ...
       <label class="radio-inline"><input type="radio" name="sr" id="gen" value="all">All</label>
<label class="radio-inline"><input type="radio" name="sr" id="gen" value="mn">Month</label> 
<label class="radio-inline"><input type="radio" name="sr" id="gen" value="yr">Year</label> 
    ...
    <div class="col-sm-12 col-md-9 col-lg-9 ">
      <input class="form-control" type="text" name="sr_txt" id="sr_txt">
    </div>
  </div>
